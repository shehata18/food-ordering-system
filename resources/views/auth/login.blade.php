...
<div class="container" dir="rtl">
    <div class="row justify-content-center">
        <div class="col-md-6">
            <div class="card">
                <div class="card-header text-center text-light" style="background-color: #20c997">{{ __('تسجيل الدخول') }}</div>
                    ...
                    <div class="row text-center">
                        <div class="row mb-0">
                            <div class="col-md-12 offset-md-4">
                                <button type="submit" class="btn text-light" style="background-color: #20c997">
                                    {{ __('دخول') }}
                                </button>
