...
@section('content')
    ...
    <div class="container " dir="rtl">
        <div class="row justify-content-center">
            <div class="col-md-6">
                <div class="card">
                    <div class="card-header text-light bg-success text-center">الوجبة</div>
            ...
            <div class="col-md-5">
                <div class="card">
                    <div class="card-header bg-success text-light text-center"> معلومات الطلب</div>
                    ...
                    @if(Auth::check())
                        <form action="{{route('order.store')}}" method="post">
                            ...
                            <div class="form-group ">
                                <p class="data" ><strong style="color: seagreen ; font-size: 18px  ">الاسم : </strong>{{ auth()->user()->name }}</p>
                                <p class="data"><strong style="color: seagreen ; font-size: 18px  ">الايميل : </strong>{{ auth()->user()->email }}</p>
