            ...
            <div class="col-md-4">
                <div class="card">
                    ...
                    <div class="card-body text-right">
                        <ul class="list-group">
                            <a href="{{ route('cat.show') }}" class="list-group-item list-group-item-action btn btn-danger ">إضافة صنف</a>
                            <a href="{{ route('meal.index') }}" class="list-group-item list-group-item-action btn btn-danger ">عرض الوجبات</a>

                            <a href="/home" class="list-group-item list-group-item-action btn btn-danger ">طلبات
                                المستخدمين</a>
                        ...
                        <div class="card-body text-right">
                            ...
                            <div class="form-group">
                                ...
                                <div class="controls">
                                    ...
                                    <div class="form-group">
                                        <img id="showImage" src="{{url('/upload/no_image.jpg')}}" alt="No image" style="width: 100px; height: 100px;">
                                    </div>
